...
const Projects: React.FC<ProjectsProps> = ({ title, description, tags, thumbnail }) => {
  return (
    <div className="bg-gradient-to-br from-[#181525] to-[#1d1d30] overflow-hidden rounded-lg shadow-[#181524] shadow-lg transform transition-all duration-300
